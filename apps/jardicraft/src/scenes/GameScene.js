...
export class GameScene extends Phaser.Scene {
  ...
  floatText(msg,ok=true){ const t=this.add.text(640,96,msg,{fontFamily:'monospace',fontSize:18,color:ok?'#dfffc0':'#ffd0b0',backgroundColor:'#101820cc',padding:{x:14,y:8}}).setOrigin(.5).setScrollFactor(0).setDepth(20000); this.tweens.add({targets:t,y:74,alpha:0,duration:1900,onComplete:()=>t.destroy()}); }
