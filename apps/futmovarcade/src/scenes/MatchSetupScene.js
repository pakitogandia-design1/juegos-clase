...
export class MatchSetupScene extends Phaser.Scene{
  ...
  create(){
    ...
    if(this.mode==='local'){
      this.inputs.push(inputBox(this,470,205,290,'Jugador 1','Fran'));
      ...
      this.inputs.push(inputBox(this,640,190,330,'Tu nombre','Fran'));
  ...
  startMatch(){
    const p1=this.inputs?.[0]?.value||'Jugador 1';
