...
export default class BootScene extends Phaser.Scene {
  ...
  preload(){
    ...
    loadImage('menu-poster','assets/menu-poster.jpg?v=2');
    loadImage('ending-poster','assets/ending-poster.jpg?v=2');
    ...
    scenesData.forEach(s => loadImage(s.id, s.bg + '?v=2')); // v2: fondos nuevos integrados
