...
## Ajuste de jugabilidad

- El nivel se supera únicamente al limpiar todo el tablero.
- Hay 30 segundos iniciales de gracia antes de que el tablero pueda empezar a bajar.
- La bajada del tablero es más lenta y menos agresiva que en la versión inicial.
