...
export default class GameScene extends Phaser.Scene {
  ...
  create(){
    ...
    this.touch = {left:false,right:false,up:false,down:false,shoot:false,shootRational:false,shootIrrational:false};
  ...
  updateHud(){
    ...
    this.harpoonLabel.setText(`Arpón: ${this.currentHarpoon === 'rational' ? 'RACIONAL' : 'IRRACIONAL'} · Z=R · X=I`);
  ...
  createTouchControls(){
    ...
    make(748,468,'R','shootRational'); make(824,468,'I','shootIrrational'); make(900,468,'⇄','change');

    this.add.text(748,506,'racional',{fontSize:10,color:'#bae6fd',fontStyle:'bold'}).setOrigin(.5).setDepth(81);
    this.add.text(824,506,'irracional',{fontSize:10,color:'#f5d0fe',fontStyle:'bold'}).setOrigin(.5).setDepth(81);
  }
