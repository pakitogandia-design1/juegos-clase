...
export default class GameScene extends Phaser.Scene {
  ...
  updateHud(){
    ...
    this.harpoonLabel.setText(`${this.currentWeapon === 'harpoon' ? 'Arpón' : 'Escopeta'} ${this.currentHarpoon === 'rational' ? 'RACIONAL' : 'IRRACIONAL'} · Z=R · X=I · E=arma`);
  ...
  switchWeapon(){
    ...
    const label = this.currentWeapon === 'harpoon' ? 'Arpón vertical' : 'Escopeta horizontal';
  ...
  update(time, delta){
    ...
    this.currentWeapon = 'harpoon';
      this.updateHud();
      this.harpoons.shoot(this.player.sprite.x, this.player.sprite.y-28, 'rational');
    }
    if (Phaser.Input.Keyboard.JustDown(this.keys.X) || this.touch.shootIrrational) {
      this.touch.shootIrrational = false;
      this.currentHarpoon = 'irrational';
      this.updateHud();
      this.harpoons.shoot(this.player.sprite.x, this.player.sprite.y-28, 'irrational');
    }
